    ...
    return (
        <DashboardShell>
            ...
            <div className="p-6 border-b border-foreground/20 bg-background">
                ...
                <p className="text-sm text-foreground/60 mt-1">Manage your profile and preferences</p>
            </div>
            ...
            <div className="p-8 max-w-3xl">
                ...
                <div className="border border-foreground/20 bg-background mb-6">
                    <div className="p-4 border-b border-foreground/20 bg-foreground/5 flex items-center gap-3">
                        ...
                        <h2 className="font-bold uppercase text-sm tracking-wider text-foreground">Profile Information</h2>
                    </div>
                    <div className="p-6 space-y-6">
                        ...
                        <div className="flex items-start gap-4">
                            ...
                            <div className="flex-1">
                                <p className="text-xs font-bold uppercase tracking-wider text-foreground/60">Email Address</p>
                                <p className="text-lg font-medium mt-1 text-foreground">{user?.email || 'Loading...'}</p>
                            </div>
                        </div>
                        ...
                        <div className="flex items-start gap-4">
                            ...
                            <div className="flex-1">
                                <p className="text-xs font-bold uppercase tracking-wider text-foreground/60">User ID</p>
                        ...
                        <div className="flex items-start gap-4">
                            ...
                            <div className="flex-1">
                                <p className="text-xs font-bold uppercase tracking-wider text-foreground/60">Account Created</p>
                ...
                <div className="border border-swiss-orange bg-background">
                    ...
                    <div className="p-6 flex items-center justify-between">
                        <div>
                            ...
                            <p className="text-sm text-foreground/60">End your current session and return to login</p>
                        </div>
                        <button
